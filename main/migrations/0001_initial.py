    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dimensions', models.CharField(blank=True, max_length=255, verbose_name='Габариты')),
                ...
                ('clothing_sizes', models.CharField(blank=True, max_length=255, null=True, verbose_name='Размеры одежды')),
